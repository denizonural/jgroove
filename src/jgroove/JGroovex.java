...
public class JGroovex {
	...
	public static JsonSearchResults getSearchResults(String query, String type) throws IOException {
		...
		parameters.put("country", JsonPost.country);
	...
	public static void createPlaylist(String playlistName, String playlistAbout, List<String> ids) throws IOException{
		HashMap<String, Object> parameters = new HashMap<String, Object>();
		parameters.put("country", JsonPost.country);
	...
	public static JsonCountry getCountry() throws IOException{
		String response = JGroove.callMethod(null, "getCountry");
		return (new Gson().fromJson(response, JsonCountry.class));
	}
	 ...
	 */
	public static SongStream getSongStream(String ip, String streamKey) throws IOException {
		...
		return new SongStream(conn.getContentLength(), conn.getInputStream());
	}
}
